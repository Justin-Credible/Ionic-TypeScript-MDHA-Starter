    ...
    */
    export class Utilities {
        ...
        public get categories(): ViewModels.CategoryItemViewModel[]{
            ...
            var categories = [
                new ViewModels.CategoryItemViewModel("Category 1", "#/app/cat1", "ios7-pricetags-outline", 0),
                new ViewModels.CategoryItemViewModel("Category 2", "#/app/cat2", "ios7-pricetags-outline", 1),
                new ViewModels.CategoryItemViewModel("Category 3", "#/app/cat3", "ios7-pricetags-outline", 2),
                new ViewModels.CategoryItemViewModel("Category 4", "#/app/cat4", "ios7-pricetags-outline", 3)
            ];
